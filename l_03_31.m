%
% -(cu')' = f with c and f piecewise constant functions
% u(0) = alpha
% c(1)*u'(1) = gamma
% or
% u(1) = beta
...
syms xs c1 c2 f1 f2 alpha beta gamma real;
%
u1 = A*x^2 + B*x + C ;
u2 = D*x^2 + E*x + F ;
%
...
%
% Dirichlet
eq6 = subs(u2,x,1) - beta ;
% Neumann
% eq6 = subs(c2*diff(u2,x),x,1) - gamma ;
...
% % other sets of interestng parameters
% vc1 = 1 ;
% vc2 = 1 ;
% vf1 = 10 ;
% vf2 = 10 ;
...
% Dirichlet - Dirichlet
%
u1 = subs(u1,[c1 c2 f1 f2 alpha beta xs], [vc1 vc2 vf1 vf2 valpha vbeta vxs]);
u2 = subs(u2,[c1 c2 f1 f2 alpha beta xs], [vc1 vc2 vf1 vf2 valpha vbeta vxs]);
%
% Neumann - Neumann
%
%u1 = subs(u1,[c1 c2 f1 f2 alpha gamma xs], [vc1 vc2 vf1 vf2 valpha vgamma vxs]);
%u2 = subs(u2,[c1 c2 f1 f2 alpha gamma xs], [vc1 vc2 vf1 vf2 valpha vgamma vxs]);
